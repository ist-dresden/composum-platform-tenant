...
<cpn:component id="tenant" type="com.composum.platform.tenant.view.TenantBean">
    <div class="composum-platform-tenant_users-view">
        <div class="composum-platform-tenant_users-table" data-path="${tenant.path}">
            <table class="table table-striped table-hover table-condensed">
                ...
                <tbody>
                <c:choose>
                    <c:when test="${not empty tenant.users}">
                        <c:forEach items="${tenant.users}" var="user">
                    ...
                    <c:otherwise>
                        <tr>
                            <td colspan="10">${cpn:i18n(slingRequest,'no user joined to this tenant')}</td>
                        </tr>
                    </c:otherwise>
                </c:choose>
                </tbody>
