...
<cpn:component id="model" type="com.composum.platform.tenant.view.TenantBean" scope="request">
    <div id="change-tenant-dialog" class="dialog modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content form-panel default">
                <cpn:form classes="widget-form" action="/bin/cpm/platform/tenants/manager.change.json" method="POST">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"
                                aria-label="${cpn:i18n(slingRequest, 'Close')}"><span
                                aria-hidden="true">&times;</span></button>
                        <cpn:text tagName="h4" class="modal-title" i18n="true">Change a Tenant</cpn:text>
                    </div>
                    ...
                    <div class="modal-footer buttons">
                        ...
                        <button type="submit"
                                class="btn btn-primary change">${cpn:i18n(slingRequest, 'Change')}</button>
                    </div>
                </cpn:form>
            </div>
        </div>
