    ...
    <div id="create-tenant-dialog" class="dialog modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content form-panel default">
                <cpn:form classes="widget-form" action="/bin/cpm/platform/tenants/manager.create.json" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8">
                                <div class="form-group widget text-field-widget">
                                    ...
                                    <input name="tenant.name" class="form-control"
                                           type="text"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group widget text-area-widget">
                            ...
                            <input name="tenant.description" class="form-control" type="text"/>
                        </div>
                    </div>
